...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <form name="tx_editor_form" id="tx_editor_form" action="./write_ok.php" method="post" accept-charset="utf-8">
        <input type="hidden" name="accessToken" value="<?=$accessToken?>" />
        <input type="hidden" name="target" value="<?=$_GET['blog']?>" />
        <div class="span10">
        <ul class="breadcrumb">
            <li class="active">TISTORY OPEN API 를 이용한 글쓰기 예제 페이지 입니다.</li>
        </ul>
        <div class="well">
            <input id="title" name="title" type="text" class="input-xxlarge" placeholder="제목을 입력해 주세요" style="width:100%;"/>
        </div>
        <!-- 에디터 시작 -->
        <!--
          @decsription
      ...
      -->
        ...
        <div class="controls">
			<div class="control-group">
            	<label class="control-label">공개/비공개 설정</label>
            	<div class="controls">
              		<label class="radio">
            ...
            <button type="submit" class="btn btn-primary" onclick='saveContent()'>글 작성 완료</button>
        </div>
        </div>
        <!-- 에디터 끝 -->
