...
if ($accessToken && strpos($accessToken, 'access_token=') !== false) {
    ...
    setcookie("accessToken", '', time() - 3600, '/', 'openapi.dev.tistory.com');
    setcookie("accessToken", $accessToken, time() + 31536000, '/', 'openapi.dev.tistory.com');
}

header('Location: ' . 'http://openapi.dev.tistory.com/list.php');